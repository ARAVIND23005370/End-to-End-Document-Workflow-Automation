...
const G = `
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  :root{
    --bg:#faf7f4;--surface:#ffffff;--surface2:#f5f0eb;
    --border:#e8ddd4;--border2:#d4c4b5;
    --text:#2c1a0e;--text2:#6b4c35;--muted:#a08070;
    --accent:#7c4a1e;--accent-light:#f5ede5;--accent-dark:#5c3412;
    --success:#2d7a3a;--success-light:#edf7ef;
    --danger:#b83232;--danger-light:#faeaea;
    --warn:#b86a1a;--warn-light:#fdf3e7;
    --p1:#7c3a1e;--p1l:#f7ede5;--p2:#5c4a2a;--p2l:#f5f0e5;--p3:#2d6b3a;--p3l:#edf5ef;
    --font:'Plus Jakarta Sans',sans-serif;--mono:'JetBrains Mono',monospace;
    --shadow:0 1px 3px #2c1a0e0a,0 4px 16px #2c1a0e0a;
    --shadow-lg:0 4px 24px #2c1a0e18,0 1px 4px #2c1a0e0a;
    --r:10px;
  }
...
function LoginPage({ onLogin, onGoRegister }) {
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", background: "var(--bg)" }}>
      {/* Left */}
      <div style={{ flex: 1, background: "linear-gradient(145deg, #2c1a0e 0%, #7c4a1e 60%, #a0622a 100%)", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: 52, position: "relative", overflow: "hidden", borderRight: "1px solid var(--border)" }}>
  ...
  return (
    <PageWrap title={`Good ${new Date().getHours() < 12 ? "morning" : "afternoon"}, ${(user?.name || "there").split(" ")[0]}`}
      ...
      <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr", gap: 14, marginBottom: 22 }}>
        <div onClick={() => setPage("upload")} style={{ background: "linear-gradient(140deg, #2c1a0e, #7c4a1e)", border: "none", borderRadius: "var(--r)", padding: "20px 22px", cursor: "pointer", color: "#fff", transition: "transform .15s, box-shadow .15s", boxShadow: "var(--shadow)" }}
